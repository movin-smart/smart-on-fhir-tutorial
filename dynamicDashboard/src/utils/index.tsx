...
export const vitalOptions = [
  ...
  export const generateRandomReadings = (
    ...
    min: number,
    max: number
  ) => Array.from({ length: numPoints }, () => Math.floor(Math.random() * (max - min + 1)) + min);
  

export const useDateRange = (selectedOption: string, selectedStartDate: Date | null, selectedEndDate: Date | null) => {
...
export const generateLabelsForDateRange = (
  startDate: Date | null,
  endDate: Date | null
) => {
